...
| CHECKOUT-001 | Checkout Information | Begin checkout with product              | Customer information page opens                                    | P0       | Smoke, Functional         | Yes        | Automated |
| CHECKOUT-002 | Checkout Information | Submit all fields empty                  | First required-field validation is displayed                       | P1       | Negative                  | Yes        | Automated |
| CHECKOUT-003 | Checkout Information | Submit without last name                 | Last-name validation is displayed                                  | P1       | Negative                  | Yes        | Automated |
| CHECKOUT-004 | Checkout Information | Submit without postal code               | Postal-code validation is displayed                                | P1       | Negative                  | Yes        | Automated |
| CHECKOUT-005 | Checkout Information | Submit valid customer information        | Checkout overview page opens                                       | P0       | Functional                | Yes        | Automated |
| CHECKOUT-006 | Checkout Information | Cancel customer information              | User returns to cart without unintended changes                    | P2       | Navigation                | Yes        | Automated |
| OVERVIEW-001 | Checkout Overview    | Display selected products                | Overview contains the correct selected products                    | P0       | Functional                | Yes        | Automated |
| OVERVIEW-002 | Checkout Overview    | Validate item total                      | Item total equals sum of displayed product prices                  | P0       | Calculation               | Yes        | Automated |
| OVERVIEW-003 | Checkout Overview    | Validate final total                     | Final total equals item total plus tax                             | P0       | Calculation               | Yes        | Automated |
| OVERVIEW-004 | Checkout Overview    | Cancel checkout overview                 | User returns to inventory as designed                              | P2       | Navigation                | Yes        | Automated |
| ORDER-001    | Order Completion     | Complete valid order                     | Confirmation page and success message are displayed                | P0       | E2E, Smoke                | Yes        | Automated |
| ORDER-002    | Order Completion     | Return home after completion             | User returns to inventory and order state is reset                 | P1       | E2E                       | Yes        | Automated |
